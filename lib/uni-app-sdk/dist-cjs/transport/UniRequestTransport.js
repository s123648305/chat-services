...
exports.UniRequestTransport = void 0;
exports.createUniRequestTransport = createUniRequestTransport;
class UniRequestTransport {
    constructor(input) {
        this.input = input;
    }
    request(request) {
...
exports.UniRequestTransport = UniRequestTransport;
function createUniRequestTransport(input) {
